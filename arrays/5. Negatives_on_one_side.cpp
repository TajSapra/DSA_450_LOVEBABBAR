...
// }
// We can use the sorting algos but their time complexity is O(nlogn). However we can solve this problem in O(n) time using simple implementaion approach.
void fun(){
    int n;
    cin>>n;
    vi input(n);

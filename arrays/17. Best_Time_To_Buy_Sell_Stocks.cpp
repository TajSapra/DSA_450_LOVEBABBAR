// There are many variations of this questions on Leetcode and other webpages
// I will do the other versions of this question later in the Extras folder
#include<bits/stdc++.h> 
...
void fun(){
    ...
    int mi=INT_MAX, profit=0;
    fr(i,0,n,1){
        if(input[i]<mi){
            mi=input[i];
        }
        profit=max(profit, input[i]-mi);
    }
    cout<<profit<<endl;
}
int main(){

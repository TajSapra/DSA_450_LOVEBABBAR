...
// }
void fun(){
    // GFG expects O(n1+n2+n3) time and space complexity. We can do in better for space. Space: O(n1+n2), Time: O(n1+n2+n3)
    int n1, n2, n3;
    cin>>n1>>n2>>n3;
    vi input1(n1), input2(n2), input3(n3);
    fr(i,0,n1,1){
        cin>>input1[i];
    }
    fr(i,0,n2,1){
